/****************************************************************************
** Meta object code from reading C++ file 'ircsession.h'
**
** Created: Sun Aug 21 15:50:34 2011
...
#error "The header file 'ircsession.h' doesn't include <QObject>."
...
static const uint qt_meta_data_Irc__Session[] = {
 ...
 // signals: signature, parameters, type, tag, flags
     ...
     909,  896,   13,  238, 0x05,
     970,  947,   13,  238, 0x05,
    1036, 1017,   13,  238, 0x05,
    1102, 1088,   13,  238, 0x05,

 // slots: signature, parameters, type, tag, flags
    1163, 1149,   13,   13, 0x0a,
    1205, 1196,   13,   13, 0x2a,
    1230,   13,   13,   13, 0x2a,
    1248,   13,   13,   13, 0x0a,
    1268,   13,   13,   13, 0x0a,
    1304, 1296, 1291,   13, 0x0a,
    1317,   13, 1291,   13, 0x0a,
    1336, 1324, 1291,   13, 0x0a,
    1366, 1358, 1291,   13, 0x2a,
    1395, 1380, 1291,   13, 0x0a,
    1417, 1358, 1291,   13, 0x2a,
    1438, 1431, 1291,   13, 0x0a,
    1452,   13, 1291,   13, 0x2a,
    1459, 1358, 1291,   13, 0x0a,
    1474, 1358, 1291,   13, 0x0a,
    1488,   13, 1291,   13, 0x2a,
    1500, 1495, 1291,   13, 0x0a,
    1515, 1495, 1291,   13, 0x0a,
    1543, 1531, 1291,   13, 0x0a,
    1572, 1565, 1291,   13, 0x2a,
    1600, 1586, 1291,   13, 0x0a,
    1623, 1358, 1291,   13, 0x2a,
    1651, 1638, 1291,   13, 0x0a,
    1695, 1675, 1291,   13, 0x0a,
    1725, 1638, 1291,   13, 0x2a,
    1764, 1747, 1291,   13, 0x0a,
    1805, 1789, 1291,   13, 0x0a,
    1845, 1829, 1291,   13, 0x0a,
    1886, 1873, 1291,   13, 0x0a,
    1926, 1915, 1291,   13, 0x0a,
    1953,  128,   13,   13, 0x0a,
    1986,   13,   13,   13, 0x0a,
    2006, 1296, 1291,  238, 0x0a,
    2023, 1324, 1291,  238, 0x0a,
    2048, 1358, 1291,  238, 0x2a,
    2065, 1380, 1291,  238, 0x0a,
    2090, 1358, 1291,  238, 0x2a,
    2107, 1431, 1291,  238, 0x0a,
    2124,   13, 1291,  238, 0x2a,
    2134, 1358, 1291,  238, 0x0a,
    2152, 1358, 1291,  238, 0x0a,
    2169,   13, 1291,  238, 0x2a,
    2179, 1495, 1291,  238, 0x0a,
    2197, 1531, 1291,  238, 0x0a,
    2222, 1565, 1291,  238, 0x2a,
    2239, 1586, 1291,  238, 0x0a,
    2265, 1358, 1291,  238, 0x2a,
    2283, 1638, 1291,  238, 0x0a,
    2310, 1675, 1291,  238, 0x0a,
    2343, 1638, 1291,  238, 0x2a,
    2368, 1747, 1291,  238, 0x0a,
    2396, 1789, 1291,  238, 0x0a,
    2423, 1829, 1291,  238, 0x0a,
    2454, 1873, 1291,  238, 0x0a,
    2486, 1915, 1291,  238, 0x0a,
    2516,   13,   13,   13, 0x08,
    2531,   13,   13,   13, 0x08,
    2549,   13,   13,   13, 0x08,
    2564,   13,   13,   13, 0x08,
    ...
    2614,   13,   13,   13, 0x08,
    2628,   13,   13,   13, 0x08,
    2649, 2647,   13,   13, 0x08,
    2676, 2647,   13,   13, 0x08,
    2701, 2647,   13,   13, 0x08,
    2736, 2733,   13,   13, 0x08,
    2776, 2647,   13,   13, 0x08,
    2809, 2733,   13,   13, 0x08,
    2845, 2733,   13,   13, 0x08,
    2880, 2647,   13,   13, 0x08,
    2916, 2647,   13,   13, 0x08,
    2951, 2647,   13,   13, 0x08,
    2991, 2647,   13,   13, 0x08,
    3029, 2647,   13,   13, 0x08,
    3075, 3068,   13,   13, 0x08,
    3127, 2647,   13,   13, 0x08,

 // properties: name, type, flags
    3186, 3174, 0x0b095103,
    3207, 3203, 0x02095103,
    3237, 3226, 0x0c095103,
    3254, 3246, 0x0a095103,
    3259, 3246, 0x0a095103,
    1495, 3246, 0x0a095103,
    3273, 3265, 0x0009510b,
    3281, 3246, 0x0a095103,
    3298, 3290, 0x85095103,
    3303, 3246, 0x0a095103,
    3312, 3174, 0x0b095001,
    3334, 3174, 0x0b095001,
 ...
 // enum data: key, value
    3361, uint(Irc::Session::NoOptions),
    3371, uint(Irc::Session::StripNicks),
    3382, uint(Irc::Session::EchoMessages),
    3361, uint(Irc::Session::NoOptions),
    3371, uint(Irc::Session::StripNicks),
    3382, uint(Irc::Session::EchoMessages),
...
static const char qt_meta_stringdata_Irc__Session[] = {
    "Irc::Session\0\0connected()\0welcomed()\0"
    "reconnecting()\0disconnected()\0buffer\0"
    "bufferAdded(Irc::Buffer*)\0"
    "bufferRemoved(Irc::Buffer*)\0capabilities\0"
    "capabilitiesListed(QStringList)\0"
    "capabilitiesAcked(QStringList)\0"
    "capabilitiesNotAcked(QStringList)\0"
    "Q_DECL_DEPRECATED\0origin,channel\0"
    "msgJoined(QString,QString)\0"
    "origin,channel,message\0"
    "msgParted(QString,QString,QString)\0"
    "origin,message\0msgQuit(QString,QString)\0"
    "origin,nick\0msgNickChanged(QString,QString)\0"
    "origin,receiver,mode,args\0"
    "msgModeChanged(QString,QString,QString,QString)\0"
    "origin,channel,topic\0"
    "msgTopicChanged(QString,QString,QString)\0"
    "origin,receiver,channel\0"
    "msgInvited(QString,QString,QString)\0"
    "origin,channel,nick,message\0"
    "msgKicked(QString,QString,QString,QString)\0"
    "origin,receiver,message\0"
    "msgMessageReceived(QString,QString,QString)\0"
    "origin,receiver,notice\0"
    "msgNoticeReceived(QString,QString,QString)\0"
    "origin,request\0msgCtcpRequestReceived(QString,QString)\0"
    "origin,reply\0msgCtcpReplyReceived(QString,QString)\0"
    "origin,receiver,action\0"
    "msgCtcpActionReceived(QString,QString,QString)\0"
    "origin,code,params\0"
    "msgNumericMessageReceived(QString,uint,QStringList)\0"
    "origin,params\0"
    "msgUnknownMessageReceived(QString,QStringList)\0"
    "hostName,port\0connectToServer(QString,quint16)\0"
    "hostName\0connectToServer(QString)\0"
    "connectToServer()\0reconnectToServer()\0"
    "disconnectFromServer()\0bool\0message\0"
    "raw(QString)\0motd()\0channel,key\0"
    "join(QString,QString)\0channel\0"
    "join(QString)\0channel,reason\0"
    "part(QString,QString)\0part(QString)\0"
    "reason\0quit(QString)\0quit()\0names(QString)\0"
    "list(QString)\0list()\0nick\0whois(QString)\0"
    "whowas(QString)\0target,mode\0"
    "mode(QString,QString)\0target\0mode(QString)\0"
    "channel,topic\0topic(QString,QString)\0"
    "topic(QString)\0nick,channel\0"
    "invite(QString,QString)\0nick,channel,reason\0"
    "kick(QString,QString,QString)\0"
    "kick(QString,QString)\0receiver,message\0"
    "message(QString,QString)\0receiver,notice\0"
    "notice(QString,QString)\0receiver,action\0"
    "ctcpAction(QString,QString)\0nick,request\0"
    "ctcpRequest(QString,QString)\0nick,reply\0"
    "ctcpReply(QString,QString)\0"
    "requestCapabilities(QStringList)\0"
    "clearCapabilities()\0sendRaw(QString)\0"
    "cmdJoin(QString,QString)\0cmdJoin(QString)\0"
    "cmdPart(QString,QString)\0cmdPart(QString)\0"
    "cmdQuit(QString)\0cmdQuit()\0cmdNames(QString)\0"
    "cmdList(QString)\0cmdList()\0cmdWhois(QString)\0"
    "cmdMode(QString,QString)\0cmdMode(QString)\0"
    "cmdTopic(QString,QString)\0cmdTopic(QString)\0"
    "cmdInvite(QString,QString)\0"
    "cmdKick(QString,QString,QString)\0"
    "cmdKick(QString,QString)\0"
    "cmdMessage(QString,QString)\0"
    "cmdNotice(QString,QString)\0"
    "cmdCtcpAction(QString,QString)\0"
    "cmdCtcpRequest(QString,QString)\0"
    "cmdCtcpReply(QString,QString)\0"
    "_q_connected()\0_q_disconnected()\0"
    "_q_reconnect()\0_q_error()\0"
    "_q_state(QAbstractSocket::SocketState)\0"
    "_q_readData()\0_q_joined(QString)\0,\0"
    "_q_parted(QString,QString)\0"
    "_q_quit(QString,QString)\0"
    "_q_nickChanged(QString,QString)\0,,\0"
    "_q_modeChanged(QString,QString,QString)\0"
    "_q_topicChanged(QString,QString)\0"
    "_q_invited(QString,QString,QString)\0"
    "_q_kicked(QString,QString,QString)\0"
    "_q_messageReceived(QString,QString)\0"
    "_q_noticeReceived(QString,QString)\0"
    "_q_ctcpRequestReceived(QString,QString)\0"
    "_q_ctcpReplyReceived(QString,QString)\0"
    "_q_ctcpActionReceived(QString,QString)\0"
    ",code,\0_q_numericMessageReceived(QString,uint,QStringList)\0"
    "_q_unknownMessageReceived(QString,QStringList)\0"
    "QStringList\0autoJoinChannels\0int\0"
    "autoReconnectDelay\0QByteArray\0encoding\0"
    "QString\0host\0ident\0Options\0options\0"
    "password\0quint16\0port\0realName\0"
    "supportedCapabilities\0enabledCapabilities\0"
    "Option\0NoOptions\0StripNicks\0EchoMessages\0"
};

const QMetaObject Irc::Session::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Irc__Session,
      qt_meta_data_Irc__Session, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Irc::Session::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *Irc::Session::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *Irc::Session::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Irc__Session))
...
// SIGNAL 0
void Irc::Session::connected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void Irc::Session::welcomed()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void Irc::Session::reconnecting()
{
    QMetaObject::activate(this, &staticMetaObject, 2, 0);
}

// SIGNAL 3
void Irc::Session::disconnected()
{
    QMetaObject::activate(this, &staticMetaObject, 3, 0);
}

// SIGNAL 4
void Irc::Session::bufferAdded(Irc::Buffer * _t1)
{
...
// SIGNAL 5
void Irc::Session::bufferRemoved(Irc::Buffer * _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 6
void Irc::Session::capabilitiesListed(const QStringList & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 7
void Irc::Session::capabilitiesAcked(const QStringList & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 8
void Irc::Session::capabilitiesNotAcked(const QStringList & _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 9
void Irc::Session::msgJoined(const QString & _t1, const QString & _t2)
{
...
// SIGNAL 10
void Irc::Session::msgParted(const QString & _t1, const QString & _t2, const QString & _t3)
{
...
// SIGNAL 11
void Irc::Session::msgQuit(const QString & _t1, const QString & _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 12
void Irc::Session::msgNickChanged(const QString & _t1, const QString & _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 13
void Irc::Session::msgModeChanged(const QString & _t1, const QString & _t2, const QString & _t3, const QString & _t4)
{
...
// SIGNAL 14
void Irc::Session::msgTopicChanged(const QString & _t1, const QString & _t2, const QString & _t3)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
...
// SIGNAL 15
void Irc::Session::msgInvited(const QString & _t1, const QString & _t2, const QString & _t3)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
...
// SIGNAL 16
void Irc::Session::msgKicked(const QString & _t1, const QString & _t2, const QString & _t3, const QString & _t4)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)), const_cast<void*>(reinterpret_cast<const void*>(&_t4)) };
...
// SIGNAL 17
void Irc::Session::msgMessageReceived(const QString & _t1, const QString & _t2, const QString & _t3)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
...
// SIGNAL 18
void Irc::Session::msgNoticeReceived(const QString & _t1, const QString & _t2, const QString & _t3)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
...
// SIGNAL 19
void Irc::Session::msgCtcpRequestReceived(const QString & _t1, const QString & _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 20
void Irc::Session::msgCtcpReplyReceived(const QString & _t1, const QString & _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 21
void Irc::Session::msgCtcpActionReceived(const QString & _t1, const QString & _t2, const QString & _t3)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
...
// SIGNAL 22
void Irc::Session::msgNumericMessageReceived(const QString & _t1, uint _t2, const QStringList & _t3)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
...
// SIGNAL 23
void Irc::Session::msgUnknownMessageReceived(const QString & _t1, const QStringList & _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
